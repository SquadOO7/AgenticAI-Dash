        ...
        <CardContent className='space-y-4'>
          <div className='text-center'>
            ...
            <p className='text-gray-400 text-sm mb-4'>
              CityPulse would like to access your location to show nearby
              incidents and provide personalized alerts.
            </p>
          </div>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-gray-400 text-xs'>
                  Your location data is only used to show relevant incidents and
