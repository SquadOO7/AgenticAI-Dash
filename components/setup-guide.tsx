      ...
      <div className='max-w-4xl mx-auto'>
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-400'>
            Follow these steps to configure Google Authentication for CityPulse
          </p>
        </div>
...
NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID=your_measurement_id`}
          ...
          <Card className='bg-gray-900 border-gray-800'>
            ...
            <CardContent className='space-y-4'>
              <div className='text-gray-300'>
                <p className='mb-4'>
                  Go to Google Cloud Console for your Firebase project:
                </p>
                <Button
                  variant='outline'
            ...
            <CardContent className='space-y-4'>
              <div className='text-gray-300 space-y-3'>
                <div>
                  ...
                  <p className='text-sm'>
                    OAuth consent screen not configured properly. Complete Step
                    6 above.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className='text-sm'>
                    Double-check all environment variables match your Firebase
                    config exactly.
                  </p>
                </div>
              </div>
